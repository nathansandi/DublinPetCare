...
<div id="wrapper">
	...
	<div id="page" class="container">
		...
		<div id="content">
			...
			Pet Name: <br><input type="text" name="pname"><br>	
			Own Full Name: <br><input type="text" name="fname"><br>
			Gender:<br>
			...
			<br>
			Other: <br><input type="text" name="other" id="other"><br>	
		    Breed: <br><input type="text" name="breed" id="breed"><br>				

			Comments: <br><textarea name="coments" id="coments" rows ="4" cols="40"></textarea><br>
			<input type="submit" value="Contact"><br><br><input type = "reset" value="Reset">
			<br><br>
			</form>
			</div>
		<div id="sidebar2">
